...
public class RuleModelCalculator_01 implements RuleCalculator {
    ...
    public boolean match(int guid) {
        ...
        for (int i = 0; i < eventParams.size(); i++) {
            ...
            String redisKey = ruleId + ":" + conditionId;
            int currentCount = Integer.parseInt(jedis.hget(redisKey, String.valueOf(guid)));
        ...
        // int currentCount_#(for.index) = Integer.parseInt(jedis.hget(redisKey_#(for.index), String.valueOf(guid)));
        //
